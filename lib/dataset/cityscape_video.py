...
class Cityscape_Video(IMDB):
    ...
    def load_image_set_index(self):
        ...
        image_name_set = []
        with open(os.path.join(self.root_path, 'cityscapes', '%s_ImageSet.txt'%self.image_set_sub_folder)) as f:
    ...
    def load_segdb_from_index(self, index):
        ...
        video_begin_frame = int(index.split('_')[2]) - 19
        seg_rec['video_name'] = '_'.join(index.split('_')[:2]) + '_%06d'%video_begin_frame
